...
REQUIRED_PATHS = (
    ...
    "reports/zero_dice_diagnosis.json",
    "reports/zero_dice_diagnosis.md",
    ...
    "configs/classifier_v3_pilot.yaml",
    "scripts/decide_v3_source_attribution.py",
    "reports/v3_source_attribution.json",
    "reports/v3_source_attribution.md",
    "scripts/diagnose_placement_geometry.py",
    "reports/placement_geometry.json",
    "reports/placement_geometry.md",
    "scripts/build_v4_pilot_config.py",
    "configs/classifier_v4_pilot.yaml",
    "configs/classifier_v4_base.yaml",
    "scripts/decide_v4_placement_band.py",
    "reports/v4_placement_band.json",
    "reports/v4_placement_band.md",
    "configs/classifier_v5_base.yaml",
    "configs/classifier_v5_pilot_seed43.yaml",
    "configs/classifier_v5_pilot_seed44.yaml",
    "scripts/decide_v5_seed_replication.py",
    "reports/v5_seed_replication.json",
    "reports/v5_seed_replication.md",
