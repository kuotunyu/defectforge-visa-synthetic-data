...
their raw reports, and does not change any reported metric. The same local Gradio app was
tested end-to-end with a real `pcb1` anomaly upload; no public share URL was created.
